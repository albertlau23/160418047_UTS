...
class MyRecipesListAdapter(val recipesList:ArrayList<Recipe>):
    ...
    override fun onBindViewHolder(holder: RecipesListAdapter.RecipeViewHolder, position: Int) {
        ...
        holder.view.btnDetailResep.setOnClickListener {
            ...
            val action= MyRecipesFragmentDirections.actionMyRecipesFragmentToRecipesDetailFragment(recipesList[position].nama,recipesList[position].bahan,recipesList[position].cara,recipesList[position].url);
